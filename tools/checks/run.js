...
const SUITES = ['test_hygiene', 'test_details', 'test_starmap', 'test_eclipse', 'test_search_types', 'test_userlog', 'test_picker', 'test_tshirt', 'test_satellite', 'test_imagery', 'test_sw', 'test_country', 'test_favorability', 'test_paths', 'test_clearsky', 'test_years'];
