    ...
    layers.push({ id: 'relief', type: 'raster', source: 'relief',
      paint: {
        /* FADE AT HIGH ZOOM. The image is 4096x4096 — the whole world at 256px
           ...
           desert/vegetation/ocean colouring and, more importantly, still reads
           as imagery. Going fully flat would make the map look authoritative
           exactly where it is least accurate — the vector coast is ~4 km
